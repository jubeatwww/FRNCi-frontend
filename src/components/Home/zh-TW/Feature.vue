        ...
        <md-layout md-column md-align="center">
            ...
            <md-layout md-align="center" style="flex-wrap: nowrap">
                <div class="col">
                    ...
                    <p class="med-text">
                        透過語言程度、學習目標、見面頻率等關鍵篩選，讓你更有效率找到適合的學伴，減少到處發文私訊、協調見面時間的心力。
                    </p>
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <h5 class="mt-3 text-black">彈性的點數機制</h5>
                    <p class="med-text">
                        透過精心設計的點數機制，減少社群中亂槍打鳥的機率。點數不只可以作為線上媒合學伴使用，也能折抵線下活動參與費用。
                    </p>
                </div>
                <div class="col">
                    <img src="/static/img/feature4.png" style="width:150px;">
                    <h5 class="mt-3 text-black">合作夥伴的優惠</h5>
                    <p class="med-text">
                        付費會員能享有合作夥伴提供的專屬優惠或加值服務，包含語言交換的場地空間、機場接駁服務、戶外活動體驗平台等內容。
                    </p>
                </div>
            </md-layout>
        </md-layout>
